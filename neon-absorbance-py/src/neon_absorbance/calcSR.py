...
#
# Description: Calculate the spectral slope ratio (SR = S275-295 / S350-400)
#   from NEON water chemistry scan data using linear regression of
#   log(absorbance) on wavelength over each band. Optionally applies
#   Fe(III) correction.
#
